...
from src.controllers.controller import OlaController, RegisterController, LoginController, HomeController,CreateBetController
...
app.secret_key = os.urandom(24)  # Gera uma chave aleatória de 24 bytes
